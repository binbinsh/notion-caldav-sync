...
export const translations = {
  en: {
    ...
    setupStep2: "Connect Apple Calendar",
    setupStep3: "Run your first sync",
    setupStep1Done: "Notion connected",
    setupStep2Done: "Apple Calendar configured",
    setupStep2Desc: "Enter your Apple ID and an app-specific password to connect your iCloud calendar.",
    setupStep3Desc: "Everything is connected! Run a full sync to start seeing your Notion tasks in your calendar.",
  ...
  "zh-hans": {
    ...
    setupStep2: "连接 Apple 日历",
    setupStep3: "运行首次同步",
    setupStep1Done: "Notion 已连接",
    setupStep2Done: "Apple 日历已配置",
    setupStep2Desc: "输入你的 Apple ID 和 App 专用密码来连接 iCloud 日历。",
    setupStep3Desc: "一切就绪！运行全量同步，将 Notion 任务同步到日历。",
    setupRunSync: "运行首次同步",
  ...
  "zh-hant": {
    ...
    setupStep2: "連接 Apple 行事曆",
    setupStep3: "執行首次同步",
    setupStep1Done: "Notion 已連接",
    setupStep2Done: "Apple 行事曆已設定",
    setupStep2Desc: "輸入你的 Apple ID 和 App 專用密碼來連接 iCloud 行事曆。",
    setupStep3Desc: "一切就緒！執行全量同步，將 Notion 任務同步到行事曆。",
    setupRunSync: "執行首次同步",
